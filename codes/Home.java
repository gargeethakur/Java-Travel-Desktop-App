...
public class Home extends JFrame{
	...
	m2.add(mi5);
        ...
        mi6.addActionListener((ActionEvent ae) -> {
            try{
        ...
        mi7.addActionListener((ActionEvent ae) -> {
            try{
	...
	mi5.addActionListener((ActionEvent ae) -> {
            try{
	...
	mi9.addActionListener((ActionEvent ae) -> {
            try{
                new CheckHotels().setVisible(true);
            }catch(Exception e ){}
        });
        
        mi10.addActionListener((ActionEvent ae) -> {
            try{
	...
	m4.add(mi11);
        ...
        mi11.addActionListener((ActionEvent ae) -> {
	...
	m6.add(mi14);
        ...
        mi13.addActionListener((ActionEvent ae) -> {
            try{
        ...
        mi14.addActionListener((ActionEvent ae) -> {
            try{
