...
public class ForgotPassword extends JFrame implements ActionListener{
	...
	setContentPane(contentPane);
        contentPane.setBackground(Color.decode("#eaf3e3"));
	...
	b1.setBackground(Color.decode("#eaf3e3"));
        b1.setForeground(Color.decode("#8a967a"));
        contentPane.add(b1);
	...
	b2.setBackground(Color.decode("#eaf3e3"));
        b2.setForeground(Color.decode("#8a967a"));
	contentPane.add(b2);
	...
	b3.setBounds(233, 270, 101, 29);
        b3.setBackground(Color.decode("#eaf3e3"));
        b3.setForeground(Color.decode("#8a967a"));
	contentPane.add(b3);

	JPanel panel = new JPanel();
	panel.setBounds(47, 45, 508, 281);
        panel.setBackground(Color.decode("#f2f7eb"));
